...
def main():
    ...
    infile = 'pairfreq.list.allpairfreq.dist210.n1'
    ddict = {}
    with open(infile) as fp:
        for line in fp:
            #                         | dist starts here ...
            # 10 DS 0.011235 7.741023 0.009620 0.001446 ...
            line = line.strip()
            if len(line) == 0:
                continue
            sarr = line.split(' ')
            rk = '%s%s' % (sarr[1][1],sarr[1][0])
            # ddict['DS'] = ['0.100000', '0.200000', '0.300000'] ...
    ...
    im, cbar = heatmap(harvest, label210, label400, ax=ax,
                       cmap="RdBu", cbarlabel="double variance")
